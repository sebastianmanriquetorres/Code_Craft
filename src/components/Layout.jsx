...
import { ChevronsLeft, ChevronsRight, LayoutDashboard, Briefcase, Users, Star, Calendar, User, LogOut, Sun, Moon, Power, CreditCard, Package, Heart, Book } from 'lucide-react';
...
const Layout = ({ children, currentUser, setCurrentUser, users, setUsers }) => {
  ...
  const baseNav = [
    ...
    { to: 'https://drive.google.com/file/d/1UFh-fB16jD8wCAemBx_oXuOYPyHihoaZ/view?usp=sharing', icon: Book, label: 'Manual de Usuario', external: true },
  ];
