...
const AdminDashboard = ({ users, projects }) => {
  ...
  // Adjusted colors for better visibility in both themes, especially dark mode
  const PIE_CHART_COLORS = theme === 'dark' 
    ? ['#60a5fa', '#a78bfa', '#f87171'] // Brighter, more distinct colors for dark theme
    : ['#3b82f6', '#8b5cf6', '#ef4444']; // Standard vibrant colors for light theme

  const BAR_CHART_FILL = '#3b82f6'; // Using a specific, vibrant blue for the bar chart
