import React, { useState, useEffect, useRef } from 'react';
    ...
    const CreateProjectForm = ({ onClose, onSubmit, template, projectToEdit, currentUser }) => {
      ...
      const handleFileUpload = async (e) => {
        ...
        // This bucket might need to be created if it doesn't exist.
        // For Horizons, we assume 'project-files' bucket is available.
          ...
          >
            ...
            {template && !projectToEdit && (
              <div className="flex gap-4 items-center bg-secondary p-4 rounded-lg mb-6">
                <img alt={template.title} class="w-20 h-20 object-cover rounded-md" src="https://images.unsplash.com/photo-1702724122866-8898b15ebeac" />
                <div>
