...
```{image} _static/Inicio_de_sesion.png
:alt: Pantalla de inicio de sesión de Code_Craft
:align: center
:width: 50%
```
...
:alt: Pantalla de registro de nuevos usuarios en Code Craft
:align: center
:width: 50%
```
...
:alt: Pantalla de Email de nuevos usuarios en Code Craft
:align: center
:width: 80%
```
...
```{image} _static/Restablecer_contraseña.png
:alt: Opción de recuperación de contraseña en Code Craft
:align: center
:width: 50%
```
...
```{image} _static/email_pasword.png
:alt: Opción de recuperación de contraseña en Code Craft
:align: center
:width: 80%
```
...
```{image} _static/Panel_cliente.png
:alt: Opción de recuperación de contraseña en Code Craft
:align: center
:width: 80%
```
- **Nuevo proyecto:** Donde se le solicitan datos al cliente del proyecto 
